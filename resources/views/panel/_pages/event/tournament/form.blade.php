		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						<label>Prize</label>
						<input readonly name="prize" type="number" class="form-control input">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
                ...
                <div class="col-sm-6">
					<div class="form-group">
						...
						<input readonly name="start_activity" type="date" class="form-control input date">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input readonly name="end_activity" type="date" class="form-control input date">
					</div>
				</div>
				<div class="col-sm-12">
					<div class="form-group">
