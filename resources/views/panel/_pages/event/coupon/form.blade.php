			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input disabled name="max_coupon" type="number" min="1" class="form-control input">
					</div>
				</div>
				<div class="col-sm-12">
					<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input disabled name="start_active" type="date" class="form-control input date">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Active End On : </label>
										<input disabled name="end_active" type="date" class="form-control input date">
									</div>
								</div>
							</div>
						</div>
