...
class RunningTextController extends Controller
{
    ...
    {
        return [
            'get_data_route' => 'panel.interface.runningtext.getData',
            ...
            'action' => [
                ["route" => "panel.interface.runningtext.form", "title" => "Add Running Text", "action" => "add", "select" => false, "confirm" => false, "multiple" => false],
                ["route" => "panel.interface.runningtext.form", "title" => "Update Running Text", "action" => "update", "select" => true, "confirm" => false, "multiple" => false],
                ["route" => "panel.interface.runningtext.delete", "title" => "Delete Running Text", "action" => "delete", "select" => true, "confirm" => true, "multiple" => true]
            ]
        ];
    }
    ...
    private function formConfig()
    {
        return [
            ...
            'action' => 'panel.interface.runningtext.store',
            'readonly' => [],
            'required' => ['text', 'order']
        ];
    }
    ...
    {
        return view('panel._pages.runningtext.form', ['config' => $this->formConfig()])->render();
    }
    ...
    public function list(Request $input)
    {
        ...
        return view('panel._pages.runningtext.index', compact('config'));
    }
